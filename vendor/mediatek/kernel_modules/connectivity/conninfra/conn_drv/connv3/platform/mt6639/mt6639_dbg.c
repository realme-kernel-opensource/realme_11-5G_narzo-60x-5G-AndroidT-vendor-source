...
const struct connv3_dbg_command mt6639_pwr_dump[] = {
	/* Write, addr, mask, value, Read, addr*/
	{true, 0x7c060c04, 0x0, 0x00030000, true, 0x7c060c00},
	{false, 0, 0, 0, true, 0x7c001230},
	{false, 0, 0, 0, true, 0x7c001308},
	{false, 0, 0, 0, true, 0x7c001344},
	{false, 0, 0, 0, true, 0x7c001700},
	{false, 0, 0, 0, true, 0x7c001320},
	{false, 0, 0, 0, true, 0x7c001200},
	{false, 0, 0, 0, true, 0x7c0601A0},
	{false, 0, 0, 0, true, 0x7c0601A4},
	{false, 0, 0, 0, true, 0x7c0601A8},
	{false, 0, 0, 0, true, 0x7c0601AC},
	{false, 0, 0, 0, true, 0x7c0601B0},
};

const struct connv3_dump_list mt6639_dmp_list_low_power = {
	"low_power_dbg", sizeof(mt6639_pwr_dump)/sizeof(struct connv3_dbg_command),
	mt6639_pwr_dump,
};

static int connv3_power_state_dump_mt6639(enum connv3_drv_type drv_type, struct connv3_cr_cb *cb)
{
	int ret;

	ret = connv3_hw_dbg_dump_utility(&mt6639_dmp_list_low_power, cb);
	if (ret)
		pr_notice("[%s] &mt6639_dmp_list_low_power dump err=[%d]", __func__, ret);
	...
	char *buf, unsigned int size)
{
	...
	ret = connv3_power_state_dump_mt6639(drv_type, cb);
